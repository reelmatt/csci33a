"""
Django settings for bookSurvey project.
...
SECRET_KEY = 'mudfqvyy-95#-d0xz^98j7p$ab=1plgnx-0l)(^shqdjyv&&&='
...
WSGI_APPLICATION = 'bookSurvey.wsgi.application'
